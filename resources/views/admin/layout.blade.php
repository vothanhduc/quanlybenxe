...
<body style="background-image: linear-gradient(-175deg, #B7F8DB 0%, #50A7C2 100%);"> 
<section id="container" >
<!--header start-->
<header class="header fixed-top clearfix">
<!--logo start-->
<div class="brand">
    <a href="{{route('ad1')}}" class="logo">
        Admin
    </a>
    ...
    <ul class="nav top-menu">
        ...
        <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="{{asset('public/admin/images/1.png')}}"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="{{asset('public/admin/images/2.png')}}"></span>
                                <span class="subject">
...
<div class="top-nav clearfix">
    ...
    <ul class="nav pull-right top-menu">
        {{-- <li>
            <inputtype="text" class="form-control search" placeholder=" Search">
        </li> --}}
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
                ...
                <li><a href="{{route('logout1')}}"><i class="fa fa-key"></i>Đăng Xuất</a></li>
            </ul>
        </li>
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                <li>
                    <a class="active" href="{{route('page1')}}">
                ...
                <li>
                    <a class="active" href="{{route('lsp1')}}">
                        <i class="fa fa-dashboard"></i>
                        <span>Loại xe</span>
                    </a>
                </li>
...
<!-- footer -->
    ...
    margin-top: 17.1%;">
			<div class="wthree-copyright">
			  <p>© 2020 Thanh Duc. All rights reserved | Design by <a href="{{route('page1')}}">Thành Đức</a></p>
			</div>
		  </div>
  <!-- / footer -->
</section>
...
<!-- calendar -->
	...
	<script src="{{asset('public/ckeditor2/ckeditor.js')}}"></script>
